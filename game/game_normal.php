...
if($score <= 30) $time=11;
else if($score > 30 && $score <=60) $time=8;
else if($score > 60 && $score <=90) $time=6;
else if($score > 90) $time=4;
...
function express(score){
	location.replace="game_normal.php";
}
function refresh(){
	for(var j=0; j<7; j++){
			$("#arrow").remove();
...
<div id="playerAns" style="text-align:center;margin:50px 565px 0px;background-color:#FFFFFF;border:5px #00BBFF solid;
