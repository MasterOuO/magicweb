...
if($score <= 50) $time=11;
else if($score > 50 && $score <=100) $time=8;
else if($score > 100 && $score <=150) $time=6;
else if($score > 150) $time=4; 
...
function express(score){
	location.replace="game_hard.php";	
}
function refresh(){
	for(var j=0; j<9; j++){
			$("#arrow").remove();
...
<div id="playerAns" style="text-align:center;margin:50px 465px 0px;background-color:#FFFFFF;border:5px #00BBFF solid;
