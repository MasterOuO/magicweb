...
<header>
  ...
  <h1 style="text-align:center">信箱</h1>
...
<article>
	...
	<table style="width:100%">
	<tr>
		<td style="width:20%">寄信人編號<br></td>
		<td style="width:50%">內容<br></td>
		<td style="width:30%">時間<br></td>
	</tr>
	<?php
		$sql="SELECT * FROM mail WHERE receiver_id='$id'";
		$result = $conn->query($sql);
		foreach($result as $value){
			?>
			<tr>
			<td style="width:20%">No.<?php echo $value['sender_id'];?><br></td>
