...
<article>
	<?php
		...
		$sql="INSERT INTO mail(sender_id, receiver_id, message, date) 
		VALUES ('$id','$receiverid' , '$talk', '$TWtime')";
		
		if ($conn->query($sql) === TRUE) {
			echo "寄信成功!";
			?><a href="send.php" style="text-decoration:none;color:#003377"><center>回寄信備份<br></td><?php
		} 
		else {
			echo "寄信失敗: " . $sql . "<br>" . $conn->error;
			?><a href="send.php" style="text-decoration:none;color:#003377"><center>回寄信備份<br></td><?php
		}
	?>
