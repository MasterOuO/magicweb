...
<article>
	...
	<?php
		...
		?>
		<br>
		訂單編號: <?php echo $orderid;?><br><br>
		產品名稱: <?php echo $row2['product_name'];?><br><br>
		數量: <?php echo $row1['quantity'];?><br><br>
		總價: <?php echo $row1['price'];?><br><br>
		送貨地址: <?php echo $row1['destination'];?><br><br>
		修改狀態<br>
		<form action="statusData.php" method="post">
		<input type="hidden" name="orderid" value="<?php echo $orderid;?>">
		<input type="radio" name="status" value="未出貨"> 未出貨
		<input type="radio" name="status" value="運送中"> 運送中
		<input type="radio" name="status" value="抵達目的"> 抵達目的<br>
