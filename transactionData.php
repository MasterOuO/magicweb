...
<article>
	...
	<?php
		...
		if($row1['payment']=='y'){
			$sql="UPDATE orders SET status='交易完成' WHERE orderid='$orderid'";
			if($conn->query($sql)===TRUE){
				echo "訂單的產品狀態更改為: 交易完成<br><br>";
			}
			else{
				echo "失敗<br><br>";
			}
			...
			?>
			<td width="5%"><a href="pay.php?orderid=<?php echo $row1['orderid'];?>" style="text-decoration:none">請先付款</a></td>
			<?php
		}
	?>
</article>
